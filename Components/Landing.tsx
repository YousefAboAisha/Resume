...
const Landing = ({
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-fixed h-screen w-[100vw] ml-[50%] translate-x-[-50%] before:blur-sm before:absolute before:bg-main-pattern dark:before:bg-main-pattern2 before:z-0 before:w-full before:h-full before:bg-fixed ">
