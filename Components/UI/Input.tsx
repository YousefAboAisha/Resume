  ...
  return (
    <div className="relative">
      ...
      <input
        value={value}
        {...rest}
        className={`h-[56px] pl-11 border border-light dark:border-dark text-text_light dark:text-text_dark rounded-[8px] outline-none duration-300 w-full focus:valid:border-primary focus:border-primary dark:focus:border-primary
